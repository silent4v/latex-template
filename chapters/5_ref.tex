...
這樣就可以引用參考資料了。在本模板中，已經使用 \verb|\addbibresource{references.bib}| 把 references.bib 加入參考來源了，只需要把對應的引用格式丟入該檔案，並確保 main.tex 的最下方有使用 \verb|\printbibliography[heading=bib]| 渲染參考文獻即可